...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2024 at 08:04 AM
...
CREATE TABLE `medication` (
  ...
  `allergie_1` text DEFAULT NULL,
  `allergie_2` text DEFAULT NULL,
  `allergie_3` text DEFAULT NULL,
  `allergie_4` text DEFAULT NULL,
  `medication_1` text DEFAULT NULL,
  `medication_2` text DEFAULT NULL,
  `medication_3` text DEFAULT NULL,
  `medication_4` text DEFAULT NULL,
  `dose_1` text DEFAULT NULL,
  `dose_2` text DEFAULT NULL,
  `dose_3` text DEFAULT NULL,
  `dose_4` text DEFAULT NULL,
  `direction_1` text DEFAULT NULL,
  `direction_2` text DEFAULT NULL,
  `direction_3` text DEFAULT NULL,
  `direction_4` text DEFAULT NULL,
  `hold_1` text DEFAULT NULL,
  `hold_2` text DEFAULT NULL,
  `hold_3` text DEFAULT NULL,
  `hold_4` text DEFAULT NULL,
  `rhesume_1` text DEFAULT NULL,
  `rhesume_2` text DEFAULT NULL,
  `rhesume_3` text DEFAULT NULL,
  `rhesume_4` text DEFAULT NULL,
  `discontinuemedications` text DEFAULT NULL,
  `new_medication_1` text DEFAULT NULL,
  `new_medication_2` text DEFAULT NULL,
  `new_medication_3` text DEFAULT NULL,
  `new_medication_4` text DEFAULT NULL,
  `new_dose_4` text DEFAULT NULL,
  `new_dose_3` text DEFAULT NULL,
  `new_dose_2` text DEFAULT NULL,
  `new_dose_1` text DEFAULT NULL,
  `new_direction_1` text DEFAULT NULL,
  `new_direction_2` text DEFAULT NULL,
  `new_direction_3` text DEFAULT NULL,
  `new_direction_4` text DEFAULT NULL,
  `pharmacy` text DEFAULT NULL,
  `NUMBER` text DEFAULT NULL,
  `called_in_by` text DEFAULT NULL,
...
INSERT INTO `medication` (`id`, `source`, `source_other`, `allergie_1`, `allergie_2`, `allergie_3`, `allergie_4`, `medication_1`, `medication_2`, `medication_3`, `medication_4`, `dose_1`, `dose_2`, `dose_3`, `dose_4`, `direction_1`, `direction_2`, `direction_3`, `direction_4`, `hold_1`, `hold_2`, `hold_3`, `hold_4`, `rhesume_1`, `rhesume_2`, `rhesume_3`, `rhesume_4`, `discontinuemedications`, `new_medication_1`, `new_medication_2`, `new_medication_3`, `new_medication_4`, `new_dose_4`, `new_dose_3`, `new_dose_2`, `new_dose_1`, `new_direction_1`, `new_direction_2`, `new_direction_3`, `new_direction_4`, `pharmacy`, `NUMBER`, `called_in_by`, `date_time`) VALUES
(1, 'SPOUSE', '', 'fdsgf', 'kjuhu', 'h', 'hjk', 'hbjk', 'kgj', 'hj', 'jh', 'hbj', 'g', 'gfhj', 'ghj', 'bj', 'kgh', 'g', 'kgjh', 'hbjkg', 'jg', 'hjg', 'ghj', 'j', 'jg', 'jhg', 'fg', 'hf', 'f', 'fhg', 'jhfyu', 'gv', 'hj', 'gfyu', 'fhg', 'gf', 'gh', 'f', 'hgfhj', 'gvhj', 'vhj', 'vhj', 'vhj', '2024-02-17 12:29:39'),
(2, 'CAREGIVER', '', 'lkjl', 'jk', 'jkl', 'j', 'kj', 'jlk', 'lkj', 'lj', 'klj', 'jk', 'lkj', 'lj', 'lkj', 'j', 'lk', 'klj', 'klj', 'klj', 'jlk', 'lkj', 'kl', 'klj', 'j', 'lkj', 'l', 'jkljkl', 'j', 'klj', 'jl', 'jlk', 'lj', ';lj', 'jl', 'jlk', 'klj', ';l', 'jlk', 'jlk', 'j', 'ljl', '2024-02-17 12:31:16');
...
(2, '', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'C2 Large varicose veins', '', 'dsf', 'dsf', '', 'dsgfu', '45fd'),
(3, '', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'C2 Large varicose veins', '', 'dsf', 'dsf', '', 'dsgfu', '45fd'),
(4, '', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'C2 Large varicose veins', '', '23', '13', '', '13', '21'),
(5, '', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'C2 Large varicose veins', '', '23', '13', '', '13', '21'),
(6, '', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '12', '312', '', '231', '321'),
(7, 'Nandu', '0000-00-00', 'd', '213', '12', '132', '123', '12', '31', '321', '231', '231', '231', '23132', '123', '123', '12', '1', '231', '231', '231', '23', '123', '1321', '23', '123', '123', '13', '131', '32', '1', '321', '231', '21', '231', '231', '2313', '', '', '2', '12', '312', '31', '231', '321'),
(8, 'Nandu', '0000-00-00', 'd', '213', '12', '132', '123', '12', '31', '321', '231', '231', '231', '23132', '123', '123', '12', '1', '231', '231', '231', '23', '123', '1321', '23', '123', '123', '13', '131', '32', '1', '321', '231', '21', '231', '231', '2313', '', '', '2', '12', '312', '31', '231', '321'),
(9, 'Nandu', '0000-00-00', 'd', '213', '12', '132', '123', '12', '31', '321', '231', '231', '231', '23132', '123', '123', '12', '1', '231', '231', '231', '23', '123', '1321', '23', '123', '123', '13', '131', '32', '1', '321', '231', '21', '231', '231', '2313', '', '', '2', '12', '312', '31', '231', '321'),
(10, 'Nandu', '0000-00-00', 'd', '213', '12', '132', '123', '12', '31', '321', '231', '231', '231', '23132', '123', '123', '12', '1', '231', '231', '231', '23', '123', '1321', '23', '123', '123', '13', '131', '32', '1', '321', '231', '21', '231', '231', '2313', '', '', '2', '12', '312', '31', '231', '321'),
(11, 'Nandu', '0000-00-00', '123112', '1321', '12312', '12', '121', '2312', '1', '23132', '123', '12', '312', '312', '12', '1', '21', '231', '231', '23', '123', '123', '12', '31', '21', '21', '231', '231', '231', '21', '231', '231', '23', '123', '123', '12', '31', '', 'C4 Skin changes without ulceration', '2', '211', '31', '3', '123', '123'),
(12, 'Nandu', '0000-00-00', '123112', '1321', '12312', '12', '121', '2312', '1', '23132', '123', '12', '312', '312', '12', '1', '21', '231', '231', '23', '123', '123', '12', '31', '21', '21', '231', '231', '231', '21', '231', '231', '23', '123', '123', '12', '31', '231', 'C4 Skin changes without ulceration', '2', '211', '31', '3', '123', '123');
